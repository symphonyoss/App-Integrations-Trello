...
/**
 * Test class to validate {@link CommentWithLinebreakCardTrelloParserTest}
 * Created by hamitay on 21/03/17.
 */
@RunWith(MockitoJUnitRunner.class)
public class CommentWithLinebreakCardTrelloParserTest extends CommonTrelloTest {
